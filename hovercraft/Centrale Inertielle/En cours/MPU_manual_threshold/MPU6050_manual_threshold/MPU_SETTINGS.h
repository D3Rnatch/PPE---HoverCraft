...
//
// TEST BUFFER READINGS OF MPU6050 Drotek Board
// 
// Documentation:
...
// MOT_DETECT_STATUS Register (register 97)
// Interpretation values, (Decalage Only ! Not so Simple !!)
#define MPU6050_MOTION_MOT_XNEG_BIT     7 // 0b1000 0000
#define MPU6050_MOTION_MOT_XPOS_BIT     6 // 0b0100 0000
...
// MASQUE calcul de direction
// GIVES AN ARCHAICAL SENSE OF MOVE !
#define MPU6050_DROIT_PLUS 0b00010000 // DEC : 16
#define MPU6050_DROIT_MOINS 0b00100000 // DEC : 32
#define MPU6050_GAUCHE 0b10000000 // DEC : 128
#define MPU6050_DROITE 0b01000000 // DEC : 64
#define MPU6050_DIAG_GAUCHE_PLUS 0b10010000 // DEC : -112
#define MPU6050_DIAG_DROIT_PLUS 0b01010000 // DEC : 80
#define MPU6050_DIAG_GAUCHE_MOINS 0b10100000 // DEC : -96
#define MPU6050_DIAG_DROIT_MOINS 0b01100000 // DEC : 96
...
typedef union accel_t_gyro_union
{
  ...
  struct
  {
    ...
    // REAL VALUES ACCEL & ROTATION
    int16_t real_x_accel;
    int16_t real_y_accel;
    int16_t real_z_accel;
    int16_t real_x_gyro;
    int16_t real_y_gyro;
    int16_t real_z_gyro;
